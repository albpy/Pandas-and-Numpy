...
for key in countries:
    for value in GDP:
        ...
        GDP.remove(value)
        break
UserInput = input("Please Enter the Country: ")
for (key, value) in res.items():
    if key == UserInput:
        print(value)
#    print(key, value) to print whole 
'''sir, terminal is close after one input.How to give input countinuosly line by line in terminal'''
